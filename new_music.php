	...
	<div class="card card-outline card-primary">
        ...
        <div class="col-md-6">
            <div class="form-group">
              <label for="" class="control-label">BPM</label>
              <input type="number" class="form-control form-control-sm" name="bpm" value="<?php echo isset($bpm) ? $bpm : '' ?>">
            </div>
          </div>
					<div class="col-md-6">
						<div class="form-group">
    	...
    	<div class="card-footer border-top border-info">
    		<div class="d-flex w-100 justify-content-center align-items-center">
    			<button id="butn" class="btn btn-flat  bg-gradient-primary mx-2" form="manage-music">Save</button>
    			<button id="butn2" class="btn btn-flat bg-gradient-secondary mx-2" type="button">Cancel</button>
    		</div>
    	</div>
	</div>
</div>
