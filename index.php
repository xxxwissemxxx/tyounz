...
<div class="wrapper">
  ...
  <div class="content-wrapper  bg-dark">
    ...
    <section class="content">
      ...
      <div id="audio-player" class="d-flex w-100 justify-content-end align-items-center bg-dark py-1 position-absoulute">
            ...
            <button class="download" onclick="doad($(this))" data-type="download">download</button>
            <audio controls class="bg-black" ended="nextAudioNode.play();" id="mplayer" nodownload>
            </audio>
    ...
    <script>
      ...
      var audio = $('<audio controls class="bg-black" id="mplayer" controlslist="nofullscreen noremoteplayback noplaybackrate foobar" data-queue = "'+$i+'"></audio>')
  ...
  <footer class="main-footer bg-black">
    <strong><a href="">TYOUNZ.com</a></strong>
