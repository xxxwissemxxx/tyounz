...
<!-- Info boxes -->
        <div class="row">
          <div class="col-12 col-sm-6 col-md-3">
            <a href="index.php?page=genre_list"><div class="info-box bg-black border border-primary">
          ...
          <!-- /.col -->
           <div class="col-12 col-sm-6 col-md-3">
           <a href="index.php?page=music_list"><div class="info-box bg-black border border-primary">
          ...
          <!-- /.col -->
          <div class="col-12 col-sm-6 col-md-3">
          <a href="index.php?page=playlist"><div class="info-box bg-black border border-primary">
          ...
          <!-- /.col -->
          <div class="col-12 col-sm-6 col-md-3">
          <a href="index.php?page=view_playlist&id=3"><div class="info-box bg-black border border-primary">
              <span class="info-box-icon bg-primary elevation-1"><i class="fas fa-list text-gradient-primary"></i></span>
